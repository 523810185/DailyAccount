...
#pragma warning disable
    ...
    public class Color32Formatter : MinimalBaseFormatter<Color32>
    {
        ...
        {
            Color32Formatter.ByteSerializer.WriteValue("r", value.r, writer);
            Color32Formatter.ByteSerializer.WriteValue("g", value.g, writer);
            Color32Formatter.ByteSerializer.WriteValue("b", value.b, writer);
            Color32Formatter.ByteSerializer.WriteValue("a", value.a, writer);
        }
    }
}