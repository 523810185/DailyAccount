...
#pragma warning disable
    ...
    public class RectFormatter : MinimalBaseFormatter<Rect>
    {
        ...
        {
            RectFormatter.FloatSerializer.WriteValue("x", value.x, writer);
            RectFormatter.FloatSerializer.WriteValue("y", value.y, writer);
            RectFormatter.FloatSerializer.WriteValue("width", value.width, writer);
            RectFormatter.FloatSerializer.WriteValue("height", value.height, writer);
