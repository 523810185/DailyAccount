...
#pragma warning disable
    ...
    public class Vector4Formatter : MinimalBaseFormatter<Vector4>
    {
        ...
        {
            Vector4Formatter.FloatSerializer.WriteValue("x", value.x, writer);
            Vector4Formatter.FloatSerializer.WriteValue("y", value.y, writer);
            Vector4Formatter.FloatSerializer.WriteValue("z", value.z, writer);
            Vector4Formatter.FloatSerializer.WriteValue("w", value.w, writer);
        }
    }
}