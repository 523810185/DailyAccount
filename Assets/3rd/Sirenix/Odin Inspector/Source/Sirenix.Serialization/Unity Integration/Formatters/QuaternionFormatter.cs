...
#pragma warning disable
    ...
    public class QuaternionFormatter : MinimalBaseFormatter<Quaternion>
    {
        ...
        {
            QuaternionFormatter.FloatSerializer.WriteValue("x", value.x, writer);
            QuaternionFormatter.FloatSerializer.WriteValue("y", value.y, writer);
            QuaternionFormatter.FloatSerializer.WriteValue("z", value.z, writer);
            QuaternionFormatter.FloatSerializer.WriteValue("w", value.w, writer);
        }
    }
}