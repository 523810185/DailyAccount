...
#pragma warning disable
    ...
    public class ColorFormatter : MinimalBaseFormatter<Color>
    {
        ...
        {
            ColorFormatter.FloatSerializer.WriteValue("r", value.r, writer);
            ColorFormatter.FloatSerializer.WriteValue("g", value.g, writer);
            ColorFormatter.FloatSerializer.WriteValue("b", value.b, writer);
            ColorFormatter.FloatSerializer.WriteValue("a", value.a, writer);
        }
    }
}