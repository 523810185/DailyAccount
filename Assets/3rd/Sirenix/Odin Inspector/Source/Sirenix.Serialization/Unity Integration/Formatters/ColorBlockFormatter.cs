...
#pragma warning disable
    ...
    public class ColorBlockFormatter<T> : MinimalBaseFormatter<T>
    {
        ...
        {
            ColorSerializer.WriteValue("normalColor", (Color)normalColor.GetValue(value, null), writer);
            ColorSerializer.WriteValue("highlightedColor", (Color)highlightedColor.GetValue(value, null), writer);
            ColorSerializer.WriteValue("pressedColor", (Color)pressedColor.GetValue(value, null), writer);
            ColorSerializer.WriteValue("disabledColor", (Color)disabledColor.GetValue(value, null), writer);
            FloatSerializer.WriteValue("colorMultiplier", (float)colorMultiplier.GetValue(value, null), writer);
            FloatSerializer.WriteValue("fadeDuration", (float)fadeDuration.GetValue(value, null), writer);
        }
    }
}