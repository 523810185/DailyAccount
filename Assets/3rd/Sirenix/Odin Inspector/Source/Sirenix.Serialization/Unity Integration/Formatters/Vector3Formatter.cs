...
#pragma warning disable
    ...
    public class Vector3Formatter : MinimalBaseFormatter<Vector3>
    {
        ...
        {
            Vector3Formatter.FloatSerializer.WriteValue("x", value.x, writer);
            Vector3Formatter.FloatSerializer.WriteValue("y", value.y, writer);
            Vector3Formatter.FloatSerializer.WriteValue("z", value.z, writer);
        }
    }
}