...
#pragma warning disable
    ...
    public class GradientFormatter : MinimalBaseFormatter<Gradient>
    {
        ...
        {
            GradientFormatter.AlphaKeysSerializer.WriteValue("alphaKeys", value.alphaKeys, writer);
            GradientFormatter.ColorKeysSerializer.WriteValue("colorKeys", value.colorKeys, writer);
