...
#pragma warning restore 0618
        ...
        protected override void Write(ref Keyframe value, IDataWriter writer)
        {
            ...
            else
            {
                ...
                KeyframeFormatter.FloatSerializer.WriteValue("inTangent", value.inTangent, writer);
                KeyframeFormatter.FloatSerializer.WriteValue("outTangent", value.outTangent, writer);
                KeyframeFormatter.FloatSerializer.WriteValue("time", value.time, writer);
                KeyframeFormatter.FloatSerializer.WriteValue("value", value.value, writer);

#pragma warning disable 0618
                KeyframeFormatter.IntSerializer.WriteValue("tangentMode", value.tangentMode, writer);
#pragma warning restore 0618
            }
        }
    }
